...
type="submit" class="mt-6 py-2 px-6 rounded-sm self-start text-sm text-white bg-primary-light duration-200 border-solid border-2 
            ...
            <router-link :to="{name: 'Register'}" class="text-center text-sm mt-6">
            Don't have an account? <span class="text-primary-light hover:cursor-pointer hover:text-primary">Sign up!</span></router-link>
        </form>
    </div>
</template>
